...
//                   },
//                   { icon: "📞", label: "Phone", val: "+91 82829 48444" },
//                   {
//                     icon: "✉️",
//                     label: "Email",
              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white font-semibold px-7 py-3 rounded-lg text-sm transition-colors inline-flex items-center gap-2"
                  >
